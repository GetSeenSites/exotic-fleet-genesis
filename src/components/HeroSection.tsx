    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in">
          <Link
            to="/fleet"
            className="border-2 border-executive-gold bg-executive-gold text-white px-8 py-4 rounded-lg text-lg font-semibold hover:chrome-button-hover transition-all duration-300 hover-lift"
          >
            Browse Our Fleet
          </Link>
          <Link
            to="/contact"
            className="border-2 border-executive-gold text-white px-8 py-4 rounded-lg text-lg font-semibold hover:chrome-button-hover transition-all duration-300"
          >
